...
namespace T1809E_PROJECT_SEM3.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            ViewBag.TotalRevenue = db.Orders.AsEnumerable().Where(x => x.CreateAt.Value.Day == DateTime.Now.Day).Sum(x => x.PriceShip);
            ViewBag.TotalOrderDay = db.Orders.AsEnumerable().Count(x => x.CreateAt.Value.Day == DateTime.Now.Day);
