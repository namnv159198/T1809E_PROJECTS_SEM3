...
namespace T1809E_PROJECT_SEM3.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Type,PricePerKm,PricePerKg,Description")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Type,PricePerKm,PricePerKg,Status,Description")] Service service)
        {
            if (ModelState.IsValid)
            {
